...
dv = xr.open_dataset(surf_path+'/Results/'+'vo_top15m_ORCA-0.25x0.25_regular_1979_2018.nc')
du = xr.open_dataset(surf_path+'/Results/'+'uo_top15m_ORCA-0.25x0.25_regular_1979_2018.nc')
...
plt.savefig(surf_path+'/Figures/'+'speed_15m_arrowplot.png', dpi=300, transparent=True)
plt.show()
